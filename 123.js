...
// для юзабельності в консооьці
const formatted = formatUsers(randomUserMock, additionalUsers);
const validUsers = formatted.filter(validateUser);

console.log("Валідні юзери:", validUsers.length);
console.log("Фільтр (Germany, female):", filterUsers(validUsers, { country: "Germany", gender: "female" }));
console.log("Сортування за віком:", sortUsers(validUsers, "age", "desc").slice(0, 3));
console.log("Пошук 'Norbert':", searchUsers(validUsers, "Norbert"));
console.log("Відсоток >30 років:", percentMatch(validUsers, u => u.age > 30), "%");